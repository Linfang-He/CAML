...
def build_parser():
    ...
    ps("--batch-size", dest="batch_size", type=int, metavar='<int>',
       default=50, help="Batch size (default=128)")
    ...
    ps("--epochs", dest="epochs", type=int, metavar='<int>',
       default=100, help="Number of epochs (default=50)")
    ...
    ps('--gen_dir', dest='gen_dir', type=str,
       default='gen_dir/', help='gen rouge file directory')
    ps('--model', dest='model', type=str,
       default='cv/test/model_best.ckpt', help='model path')
    ps('--gen_true_dir', dest='gen_true_dir', type=str,
       default='true_dir/', help='gen true rouge file directory')
